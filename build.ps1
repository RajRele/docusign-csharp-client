...
Write-Host "Cleaning SdkTests!" -ForegroundColor Orange
msbuild ./test/SdkTests/SdkTests.csproj /t:clean /verbosity:minimal
if ($lastExitCode -ne 0) { exit $lastExitCode }
    
Write-Host "Restoring and Building SdkTests for Net4.5" -ForegroundColor Orange
msbuild ./test/SdkTests/SdkTests.csproj /t:restore /p:TargetFramework=net45 /verbosity:minimal
if ($lastExitCode -ne 0) { exit $lastExitCode }

Write-Host "ReBuilding SdkTests for Net4.5" -ForegroundColor Orange
